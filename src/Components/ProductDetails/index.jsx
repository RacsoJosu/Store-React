...
const ProductDetails =()=>{
    ...
    return(
        <aside className= {` ${contextShoppingProduct.isProductDetailOpen ? 'flex':'hidden' } product-detail flex flex-col fixed border-solid border-2 right-0 border-transparent shadow-2xl rounded-lg bg-white`}>
