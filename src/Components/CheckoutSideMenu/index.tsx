...
const CheckoutSideMenu = () => {
  ...
  return (
    <aside
      className={` ${contextCheckoutSideMenu?.isCheckoutSideMenuOpen ? 'flex' : 'hidden'}   checkout-side-menu flex-col gap-3 fixed top-20 border-solid border-2 right-0 border-transparent shadow-2xl rounded-lg bg-white `}
    >
